            ...
            <div>
                <div class="casting-line">
                    ...
                    {Array.from(this.getByDepartment('Directing', props.credits.crew)).slice(0,5).map(
                        e => <CastLine profile-path={e.profile_path} name={e.name} character={e.job} href={`/person/${e.id}`}/>
                    )}
                </div>
                ...
                <div class="casting-line">
                    ...
                    {props.credits.cast.slice(0, 8).map(
                        e => <CastLine profile-path={e.profile_path} name={e.name} character={e.character} href={`/person/${e.id}`}/>
                    )}
                </div>
